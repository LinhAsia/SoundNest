use super::{DragGhostKind, DragGhostSpec};
...
use windows::Win32::{
    Foundation::{
        COLORREF, DRAGDROP_S_CANCEL, DRAGDROP_S_DROP, DRAGDROP_S_USEDEFAULTCURSORS, HWND, POINT,
        S_OK, SIZE,
    },
    Graphics::Dwm::{
...
fn draw_drag_ghost_pixels(buffer: &mut [u8], width: usize, height: usize, spec: &DragGhostSpec) {
