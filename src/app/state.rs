...
pub struct SoundFxApp {
    ...
    pub(super) last_working_set_trim_at: f64,
    pub(super) clipboard_download_url: Option<String>,
    pub(super) last_clipboard_check_at: f64,
    ...
    pub(super) playlist_volume: f32,
    pub(super) playlist_scrubbing_pos: Option<f32>,
    pub(super) playlist_volume_popup_open: bool,
    pub(super) playlist_drag_source_idx: Option<usize>,
...
impl SoundFxApp {
    pub fn new() -> Self {
        ...
        let mut app = Self {
            ...
            pending_save: false,
            last_edit_at: 0.0,
            last_working_set_trim_at: 0.0,
            clipboard_download_url: None,
            last_clipboard_check_at: 0.0,
            ...
            playlist_volume: 1.0,
            playlist_scrubbing_pos: None,
            playlist_volume_popup_open: false,
            playlist_drag_source_idx: None,
